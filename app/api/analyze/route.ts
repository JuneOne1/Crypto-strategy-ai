...
보고서에는 재미있는 이모지(🚀, 📈, 💡, ⏳, 🔥 등)를 최대한 활용하고, 각 항목마다 최소 2~3줄 이상의 상세 설명을 포함해주세요.
...
6. **전략 근거:** RSI, MACD, 거래량 등 기술적 지표 분석

## 3. 매도(Short) 전략 ⛔
- 위와 유사한 구조로, 단기 하락 모멘텀 기반 전략 제시

## 4. 최적 전략 추천 💡
- 매수와 매도 전략을 비교 후 가장 유리한 전략 추천

## 5. 종합 의견 및 유의사항 ⏳
- 시장 변동성, 거시경제 이슈, 리스크 관리 등에 대한 조언

────────────────────────────────
추가 지침:
1) **최근 7일 가격 동향**이나 **최근 시장 동향**은 절대 텍스트로 언급하지 마세요. (프론트엔드 차트로 대체)
2) 이모지를 최대한 다양하게 활용하여 재미있게 작성하세요.
